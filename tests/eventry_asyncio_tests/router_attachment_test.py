...
class TestRouterAttachment:
    def test_cannot_attach_router_to_itself(self) -> None:
        r = Router()

        with pytest.raises(rexc.RouterLoopError):
            r.attach_router(r)

    def test_cannot_attach_router_with_a_parent(self) -> None:
    ...
    def test_cannot_attach_to_ascendant_router(self) -> None:
        r0, r1, r2 = Router(), Router(), Router()
        r0.attach_router(r1)
        r1.attach_router(r2)
    ...
    def test_cannot_attach_routers_with_eq_names(self) -> None:
    ...
    def test_router_attachment(self) -> None:
...
class TestRouterDetachment:
    def test_router_detachment_from_parent(self) -> None:
        r0, r1 = Router(name='parent'), Router(name='child')
        r0.attach_router(r1)
    ...
    def test_router_detachment_from_child(self) -> None:
        r0, r1 = Router(name='parent'), Router(name='child')
        r0.attach_router(r1)
    ...
    def test_cannot_detach_non_existing_router(self) -> None:
        r0 = Router()
