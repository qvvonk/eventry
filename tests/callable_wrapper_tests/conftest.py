import pytest
from mypy.operators import int_op_to_method
...
def sync_callable_with_no_args() -> Callable[[], Literal[1]]:
    def function() -> Literal[1]: return 1
    return function
...
def async_callable_with_no_args() -> Callable[[], Awaitable[Literal[1]]]:
    async def function() -> Literal[1]: return 1
    return function
...
def callable_with_varkwargs() -> Callable[..., dict[str, Any]]:
    def function(**kwargs: Any) -> dict[str, Any]: return kwargs
    return function
...
def callable_with_varargs() -> Callable[..., tuple[Any, ...]]:
    def function(*args: Any) -> tuple[Any, ...]: return args
    return function
